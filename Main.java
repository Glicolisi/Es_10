...
public class Main {
    ...
    private static void exercise1() {
        ...
        // avevo pensato a tutti i casi possibili ed ero arrivato a utilizzare XOR negato, per poi accorgermi che era la stessa tabella di verità di un semplice ==
    ...
    private static void exercise3() {
        ...
        double ourTestScore = 9.5;
        double maxTestScore = 10;
        boolean isTestRetry = true;
        double testPercent = ourTestScore / maxTestScore * 100;
        //Non so se ho fatto correttamente, non ho dovuto negare niente, però funziona
        if(testPercent>=60&&isTestRetry){
          System.out.println("Test result=C");
        }
          else if (testPercent >= 90) {
            System.out.println("Test result=A");
        } else if (testPercent >= 80 && testPercent < 90) {
            System.out.println("Test result=B");
        } else if (testPercent >= 70 && testPercent < 80) {
            System.out.println("Test result=C");
        } else if (testPercent >= 60 && testPercent < 70) {
            System.out.println("Test result=C");
        } else if (testPercent <= 60) {
            System.out.println("Test result=F");
          }
    }
